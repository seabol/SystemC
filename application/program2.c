...
void interruptHandler(void)
{
    ...
    writeReg32(DMA_BASE, (Uns32)(0x1c), (Uns32)(0));
...
int main(int argc, char *argv[]) {
    ...
    printf("RISC-V-2 initialization\n");
    ...
    while (int_cnt < 3) 
    {
        ...
        writeReg32(DMA_BASE, (Uns32)(0x10), (Uns32)(0x300400));
        writeReg32(DMA_BASE, (Uns32)(0x14), (Uns32)(0x200000));
        writeReg32(DMA_BASE, (Uns32)(0x18), (Uns32)(0x400));
        writeReg32(DMA_BASE, (Uns32)(0x1c), (Uns32)(1));
